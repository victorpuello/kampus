...
urlpatterns = [
    ...
    path("elections/manage/processes/<int:process_id>/restart/", ElectionProcessRestartAPIView.as_view(), name="elections-manage-process-restart"),
    path("elections/manage/processes/<int:process_id>/close/", ElectionProcessCloseAPIView.as_view(), name="elections-manage-process-close"),
    ...
    path("elections/manage/processes/<int:process_id>/personero-acta.pdf", ElectionProcessPersoneroActaExportPdfAPIView.as_view(), name="elections-manage-process-personero-acta-export-pdf"),
    path("elections/manage/processes/<int:process_id>/contralor-acta.pdf", ElectionProcessContralorActaExportPdfAPIView.as_view(), name="elections-manage-process-contralor-acta-export-pdf"),
    ...
    path("elections/manage/governance-participants/", ElectionGovernanceParticipantsAPIView.as_view(), name="elections-manage-governance-participants"),
